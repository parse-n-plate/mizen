...
function GetStartedPageContent() {
  ...
  return (
    <>
      <div className="landing-scroll min-h-screen bg-white text-stone-900 dark:bg-[linear-gradient(180deg,#050505_0%,#050505_64%,#171211_64%,#171211_100%)] dark:text-stone-100">
        <header
