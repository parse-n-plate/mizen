...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-mizen-overlay",
        className
      )}
      {...props}
    />
...
function DialogContent({
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      <DialogOverlay
        className={cn(
          !animated && "data-[state=open]:animate-none data-[state=closed]:animate-none",
          overlayClassName
        )}
      />
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border p-6 shadow-lg outline-none sm:max-w-lg overscroll-contain",
          animated &&
