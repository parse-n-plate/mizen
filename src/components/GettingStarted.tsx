            ...
            {EXAMPLE_RECIPES.map((example) => {
              ...
              return (
                <button
                  ...
                  className="press-scale flex flex-col items-start gap-1 rounded-2xl border border-stone-200 dark:border-stone-700 bg-[var(--color-cream)] px-4 py-3.5 text-left transition-[color,border-color,box-shadow] hover:border-stone-300 dark:hover:border-stone-600 hover:shadow-sm disabled:opacity-50"
                >
