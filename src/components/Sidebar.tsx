      ...
      >
          ...
          {user && (
            <div className="relative">
              <button
                ref={addBtnRef}
                onClick={() => {
                  if (!quickAddOpen && addBtnRef.current) {
                ...
                style={{ color: "#ffffff" }}
                className="flex items-center gap-2.5 rounded-lg px-2.5 py-2 bg-[#45A2FB] hover:bg-[#3991e8] font-sans text-sm font-medium w-full transition-colors"
              >
                {quickAddLoading ? (
              ...
              {quickAddOpen &&
                ...
                createPortal(
                  <>
                    ...
                    <div
                      className="popover-animate fixed z-40 rounded-xl border border-stone-200 dark:border-stone-700 bg-white dark:bg-stone-900 shadow-lg overflow-hidden"
        ...
        <div className="flex flex-col px-4 pb-6 w-[240px]">
          <button
            ...
            className="flex items-center gap-2.5 rounded-lg px-2.5 py-2 font-sans text-sm text-stone-500 dark:text-stone-400 hover:bg-stone-50 dark:hover:bg-stone-800/50 hover:text-stone-700 dark:hover:text-stone-300 transition-colors"
          >
