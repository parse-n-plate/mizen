...
export function TestingControlsPanel({ className }: TestingControlsPanelProps) {
  ...
  return (
    <div
      className={cn(
        'fixed bottom-0 left-0 right-0 bg-white border-t border-[#E0E0E0] shadow-lg transition-transform duration-300 z-50',
        className,
      )}
    >
      {/* Toggle Handle */}
      ...
      <div className="max-w-4xl mx-auto p-4">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2">
            <span className="font-domine font-bold text-stone-800">
              Testing Controls
            </span>
