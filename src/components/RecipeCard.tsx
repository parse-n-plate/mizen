...
export function RecipeCard({ item, onDelete }: RecipeCardProps) {
  ...
  return (
    <button
      onClick={handleClick}
      className="group flex w-full items-center justify-between rounded-xl border border-stone-100 px-4 py-3 text-left transition-colors hover:border-stone-200 hover:bg-stone-50"
    >
      ...
      <button
        ...
        disabled={deleting}
        className="ml-3 flex-shrink-0 rounded-lg p-1.5 text-stone-300 opacity-0 transition-all hover:bg-stone-100 hover:text-stone-500 group-hover:opacity-100"
