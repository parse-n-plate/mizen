  ...
  return (
    <>
      <header className="sticky top-0 z-50">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-x-0 top-0 h-full bg-white/80 backdrop-blur-md dark:bg-stone-950/80"
        />
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-x-0 top-full h-10 bg-gradient-to-b from-white/80 via-white/40 to-transparent dark:from-stone-950/80 dark:via-stone-950/40 dark:to-transparent"
        />
                ...
                user && history.length > 1 ? (
                  <div className="relative">
                    <button
                      ...
                      className="flex items-center gap-1 truncate max-w-[min(12rem,calc(100vw-7.5rem))] sm:max-w-xs rounded-lg px-2 py-1 -mx-2 -my-1 transition-colors hover:bg-stone-100 dark:hover:bg-stone-800"
                    >
                ...
                <>
                  ...
                  <div className="relative hidden sm:block">
                    <button
                      ...
                      className="flex h-8 items-center justify-center gap-1.5 rounded-lg px-2 sm:px-3 bg-stone-900 text-stone-50 hover:bg-stone-800 dark:bg-stone-100 dark:text-stone-900 dark:hover:bg-stone-200 transition-colors"
                ...
                <div className="relative">
                  {user ? (
                    <button
                      ...
                      className="hidden sm:flex h-8 w-8 items-center justify-center rounded-lg overflow-hidden hover:ring-2 hover:ring-stone-300 dark:hover:ring-stone-700 transition-[box-shadow]"
                    >
                    ...
                    <>
                      ...
                      <div className="popover-animate absolute right-0 top-full z-40 mt-2 w-48 rounded-xl border border-stone-200 dark:border-stone-700 bg-white dark:bg-stone-900 py-1 shadow-lg">
                        <div className="border-b border-stone-100 dark:border-stone-800 px-3 py-2">
                          ...
                          <p className="truncate font-sans text-xs text-stone-400 dark:text-stone-500">
                            {user.email}
                          </p>
                        </div>
                        <Link
