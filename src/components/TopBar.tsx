              ...
              <div className="relative">
                {user ? (
                  <button
                    ...
                    className="flex h-8 w-8 items-center justify-center rounded-full overflow-hidden hover:ring-2 hover:ring-stone-300 dark:hover:ring-stone-700 transition-all"
                  >
